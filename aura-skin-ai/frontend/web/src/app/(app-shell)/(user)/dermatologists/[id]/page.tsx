          ...
          <CardContent className="py-12 text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button variant="outline" asChild>
                <Link href={`/dermatologists/${params.id}`}>Try again</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <nav className="mb-8" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm font-label text-muted-foreground">
            <li>
              <Link href="/dermatologists" className="hover:text-foreground transition-colors">
                Dermatologists
              </Link>
            </li>
            <li aria-hidden>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            {dermatologist.consultationFee != null && (
              <p className="text-sm font-medium mb-3">Consultation: ${dermatologist.consultationFee}</p>
            )}
          ...
          <div className="lg:col-span-3 flex flex-col gap-4 lg:sticky lg:top-24 lg:self-start">
            <div className="rounded-2xl border border-border/60 bg-muted/10 p-5 lg:p-6 space-y-3">
              ...
              {dermatologist.timeSlots && dermatologist.timeSlots.length > 0 && (
                <p className="text-xs text-muted-foreground">
                  Slots: {dermatologist.timeSlots.join(", ")}
                </p>
              )}
            </div>
            {dermatologist.clinicAddress && (
              <div className="rounded-2xl border border-border/60 bg-muted/10 p-5 lg:p-6">
                ...
                <p className="text-sm text-muted-foreground">{dermatologist.clinicAddress}</p>
              </div>
            )}
            ...
            <div className="rounded-2xl border border-border/60 bg-muted/10 p-5 lg:p-6">
              ...
              <p className="text-sm font-body text-muted-foreground leading-relaxed">
                You can always return to your <Link href="/reports" className="text-accent hover:underline">reports</Link> or adjust your routine before
